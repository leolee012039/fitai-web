...
interface ChatState {
  ...
  getActive: () => ChatThread | undefined;
}

function mockReply(
  q: string,
  ctx: ReturnType<typeof useHealthStore.getState>['summary'],
  nut: ReturnType<typeof useNutritionStore.getState.prototype.getContextSnapshot>,
): string {
